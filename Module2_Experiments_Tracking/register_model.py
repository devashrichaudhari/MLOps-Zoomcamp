...
#             params[param] = int(params.get(param, 42))  # Use 42 as the default value for 'random_state'
...
#     model_version=mlflow.register_model(model_uri = f"runs:/{best_run_id}/model",
...
def train_and_log_model(data_path, params):
    ...
    with mlflow.start_run():
        for param in RF_PARAMS:
            # params[param] = int(params[param])
            params[param] = int(params.get(param, 42)) 
